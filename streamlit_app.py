...
if not selected_columns:
    ...
    if selected_sector == "Select All Sectors" or selected_dimension == "Select All Dimension/Learning Areas":
        ...
        if selected_sector == "Select All Sectors" and selected_dimension == "Select All Dimension/Learning Areas":
            filtered_programmes_df = programmes_df.copy()
        elif selected_sector == "Select All Sectors":
            filtered_programmes_df = programmes_df[programmes_df['Dimension'] == selected_dimension.replace("Select All Dimension/Learning Areas", "")]
        elif selected_dimension == "Select All Dimension/Learning Areas":
            filtered_programmes_df = programmes_df[programmes_df['Sector'] == selected_sector.replace("Select All Sectors", "")]
        else:
        ...
        if not filtered_programmes_df.empty:
            ...
            st.text_input("Filter Programmes Table by any keyword", "")
