...
def display_token_counter():
    ...
    st.write("""The token counter is used for cost evaluation and not meant for end users. All values and costs displayed here are based on an estimate (Pricing derived from OpenAI's website - gpt-4o mini as at 20 October 2024).""")
